...
Enter a password and KeyCrack breaks down how an attacker would approach cracking it. It checks for common patterns like keyboard walks, repeated characters, dictionary words, and popular substitutions (like `@` for `a` or `3` for `e`).

## Built with

- Vanilla JavaScript for the core logic and UI
- Supabase for collecting anonymous feedback and bug reports
