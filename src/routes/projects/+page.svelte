...
<div class="max-w-5xl mx-auto">
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
		{#each data.projects as project}
			<div class="border border-[var(--color-border)] hover:border-emerald-400 transition-colors rounded-xl overflow-hidden bg-[var(--color-surface)]">
				<div class="px-4 pt-4 pb-3 flex items-center justify-between">
					<a href={project.github} target="_blank" rel="noopener" class="hover:underline">
				...
				<div class="px-4">
					<a
						...
						target="_blank"
						rel="noopener"
						class="block border-2 border-[var(--color-border)] hover:border-emerald-400 rounded-lg overflow-hidden transition-colors"
					>
						{#if project.image}
						...
						{:else}
							<div class="aspect-[16/10] bg-gradient-to-br from-[var(--color-surface)] to-[var(--color-bg)] flex items-center justify-center">
